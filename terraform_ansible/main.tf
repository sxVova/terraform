...
resource "google_compute_instance" "web-server" {
  ...
  sudo chmod 600 /home/rasavo99/.ssh/id_rsa
  git clone https://github.com/sxVova/ansible.git /home/rasavo99/ansible
  sudo mv gitlab /home/rasavo99/ansible/group_vars/
SCRIPT
}
